...
title("Extensión IDEAL vs. SOC", outer=TRUE, line=0, cex.main=2)

par(opar)

#savePlots(file="Extensión IDEAL vs SOC", width=4, height=6, EPS=FALSE, PDF=TRUE, PNG=TRUE)
